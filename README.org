...
* Getting into the Okta SCIM Beta
  Before building your SCIM Server, please [[https://docs.google.com/forms/d/1RKvwFaY8hoMvWn2HEnIsXYY2uaDDZZtF8-p6h2a6e4E/viewform][apply for admission to the SCIM Beta]]. Okta reviews new applicants on a weekly basis. We will reply within 7 days and give you an estimated timeline.
  ...
  1. The oktapreview.com Okta org that you will use to develop your SCIM integration. (If you don't already have an Okta org, create an [[https://www.okta.com/developer/signup/][Okta Developer account]])
